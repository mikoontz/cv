...
%\vspace{-0.5ex}
\hspace{1.5em}\emph{Co-advisors:} Andrew Latimer and Malcolm North
\vspace{1ex}
...
%\vspace{-0.5ex}
\hspace{1.5em}\emph{Committee:} Ruth Hufbauer, Tom Hobbs, Brett Melbourne

\vspace{-0.5ex}
\hspace{1.5em}\emph{Thesis: Eco-evolutionary consequences of multiple introductions for colonizing individuals}
\vspace{1ex}
...
%\vspace{-0.5ex}
\hspace{1.5em}\emph{Concentration:} Ecology, Evolution, and Conservation Biology
...
\emph{Instructor:} & ECOL592 Seminar, ``Introduction to R'' Colorado State University, 2014
\end{tabular}

\begin{tabular}{>{\raggedright}p{1.26in}>{\raggedright}p{4.75in}}
\emph{Teaching assistant:} & LIFE320 Ecology, Colorado State University, 2013 \tabularnewline 
& LIFE102 Biology Laboratory, Colorado State University, 2012 \tabularnewline
\end{tabular}

\begin{tabular}{>{\raggedright}p{1.26in}>{\raggedright}p{4.75in}}
\emph{Guest lecturer:} & LIFE320 Ecology, ``Invasion Biology'' Colorado State University, 2013
\end{tabular}
...
\hspace{0.575em}Jens Stevens$^{1}$ and Chhaya Werner$^{1}$
\emph{Broad-scale analysis of local-scale effects of aspect on vegetation productivity.}\tabularnewline
$^{1}$University of California, Davis

\hspace{0.575em}Mason Earles$^{1}$, Derek Young$^{1}$, Jens Stevens$^{1}$, Andrew Latimer$^{1}$, and Malcolm North$^{1,2}$
...
\hspace{0.575em}Lauren Nichols$^{1}$, Jackie Fitzgerald$^{1}$, Marina LaForgia$^{2}$, and Robert Dunn$^{1}$ 
...
\hspace{0.575em}Lara Kueppers$^{1}$, Cristina Castanha$^{2}$, Andrew Moyes$^{1}$, Erin Conlisk$^{3}$, and Meagan Oldfather$^{3}$ 
\emph{Responses of subalpine tree seedlings to warming within and above their altitudinal range.} \tabularnewline
$^{1}$University of California, Merced; $^{2}$Lawrence Berkeley National Laboratory; $^{3}$University of California, Berkeley
...
\begin{tabular}{>{\raggedright}p{4in}>{\raggedleft}p{2in}}
Ecological Society of America & 2014 to 2015\tabularnewline
\end{tabular}
